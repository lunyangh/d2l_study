...
# Match the local Spaceship prompt configuration. These values must be set
# before Oh My Zsh loads the theme.
SPACESHIP_PROMPT_ORDER=(venv user dir char)
...
# Make history suggestions visibly distinct in the Atom One Dark terminal.
...
# Source syntax highlighting after all other prompt and line-editor setup.
